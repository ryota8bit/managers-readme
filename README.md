...
* チームメンバーの満足度、充実度、モチベーションを提供します
  * とくにモチベーションは重要視してます
* プロダクトへコミットする
  * チームとして、方針を定めどういった戦略(What)で、プロダクトをスケールさせるかを考えコミットします
  * どうやって(How)プロダクトを作り込むかについては、メンバーにお任せしてます。
* 他部署とコミュニケーション
  * 他部署と信頼関係を築き、チーム間連携に関する開発が円滑になるよう努力します
...
私達は常にベストを尽くすため、日々議論します。 また、私達チームは一日のうち半分以上を共に過ごします。
...
## _Schedule_
私の生活は、10時に仕事を開始し、基本的には、門限が21時なので20時には仕事を終えます。21時から23時までは家族との時間としてます。
23時からネットリサーチや読書の時間になりますが、仕事と関係のない事柄も含まれます。
